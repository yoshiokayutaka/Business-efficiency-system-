...
## 最新版ダウンロード
** [こちらから最新の Excel ファイルをダウンロード](../../releases/latest)**  
※ GitHub Releases ページが開きます。`業務効率化システム_吉岡有隆_2025.xlsm` を選んでダウンロードしてください。

---

# 業務効率化システム

フリーランス・在宅ワーカー・事務職向けの **Excel ダッシュボード & VBA 自動化ツール** です。
